...
$boletinesPublicados = mysqli_query($conexion, 'SELECT id FROM boletines LIMIT 1');
if ($boletinesPublicados && mysqli_num_rows($boletinesPublicados) > 0) {
  $_GET['tipo'] = 'boletines';
  require __DIR__ . '/contenido-publico.php';
  exit;
}
?>
<!--
          ...
          <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
              <ul class="navbar-nav ml-auto">
                  ...
                  <li class="nav-item @@about__active">
                      <a class="nav-link" href="index.html#actualidad">Actualidad</a>
                  </li>
				  <li class="nav-item @@about__active">
